...
// Definition of ADC power save mode on digital I/O pins
// Disables digital I/O for power reduction, can be set
// for each single ADC pin
#ifndef ADC_POWER_SAVE_CH0_7
    #define ADC_POWER_SAVE_CH0_7 0b00000000
#endif

#ifndef ADC_POWER_SAVE_CH8_15
    #define ADC_POWER_SAVE_CH8_15 0b00000000
#endif
